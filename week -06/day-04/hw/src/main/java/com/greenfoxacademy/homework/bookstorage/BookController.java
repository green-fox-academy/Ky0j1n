package com.greenfoxacademy.homework.bookstorage;
...
public class BookController {
    ...
    public BookController() {
        ...
        books.add(new Book("Do Androids Dream of Elctric Sheep?", "Philip K. Dick", 1968 ));
    }
    ...
    public String getBokById(Model model, @PathVariable(name="id") Integer id) {
        Book bookById = null;
